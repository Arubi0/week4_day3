...
#example
text = "Hello, World!"
print(text[-3])  # prints "World"
print(text[0:5]) # prints "hello"
print(text[2:5]) # prints "llo"
print(text[-1]) #prints "!"
print(text[::-1] ) #prints" !dlorw , olleh
print(text[0:-1:2 ]) #prints "hlo ol" skips every 2nd letter
print(text[0:-1:3]) #prints "Hl r" skips every 3rd letter
text = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
# Get the substring CDE and put in a variable
substring = text.find("CDE")
print(substring) # prints 2 which is the indez of C
substring = text [2:5]
...
# #uppercase the text
# sentence = "especaially in electronic communications, writing in all caps is equivalent to yelling."
# print(sentence.upper(text)) #prints the sentence in uppercase letters

# sentence2 = "SIMPLE IS ALWAYS BETTER THAN COMPLEX"
# print(sentence2.lower()) #prints the sentence in lowercase letters

# # #find thw word communications 
...
#join the following list into a substring 
...
sentence3 = "try to be a tainbow in someone's cloud"
split_sentence3 = sentence3.split()
print(split_sentence3)# prints ['try', 'to', 'be', 'a', 'tainbow', 'in', "someone's", 'cloud']
